...
public class Reservation extends BaseEntity {
    ...
    @Builder
    public Reservation(String id, ReservationStatus reservationStatus, LocalDate startDate, LocalDate endDate, Integer term, Integer oneDayCharge, Long userId, Long roomId) {
        setId(id);
