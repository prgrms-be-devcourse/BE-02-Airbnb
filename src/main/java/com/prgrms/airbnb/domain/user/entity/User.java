...
import com.prgrms.airbnb.domain.common.util.EmailConverter;
import com.prgrms.airbnb.domain.common.util.PhoneConverter;
...
public class User extends BaseEntity {
    ...
    public User(String name, String provider, String providerId, String profileImage, Group group, Email email) {
        setName(name);
        setEmail(email);
